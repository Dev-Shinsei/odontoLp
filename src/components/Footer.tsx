export function Footer() {
  return (
    <div>
      <div className="relative bg-red-300 top-80 flex justify-start md:justify-center md:items-end ">
        <div className="flex pt-36 md:pt-32 lg:pt-40 xl:pt-6 px-4 md:px-6  xl:px-20 flex-col justify-start items-start md:justify-center md:items-center relative z-10">
          ...
          <div className="mt-12 xl:justify-between xl:flex-row flex-col-reverse items-center xl:items-start w-full ">
            <p className="mt-10 md:mt-12 xl:mt-0 text-sm leading-none text-white">
              2020 The Good Company. All Rights Reserved
            </p>
            <div className="flex mx-20 my-5 justify-center md:justify-end items-center  w-full md:w-auto md:items-center space-x-6 ">
